...
import gateway.xsocket.server.XSocketServer;
...
public class ContainerManager {
    ...
    public static void init() throws IOException {
        ...
        XSocketServer hmSocketServer = (XSocketServer) getBean("hmSocketServer");
        hmSocketServer.start();
        XSocketServer cbsSocketServer = (XSocketServer) getBean("cbsSocketServer");
